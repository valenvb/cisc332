...
# Database: OMTS
# Generation Time: 2018-03-26 14:57:41 +0000
# ************************************************************
...
CREATE TABLE `actors` (
  ...
  KEY `MovieID` (`MovieID`),
  CONSTRAINT `actors_ibfk_2` FOREIGN KEY (`MovieID`) REFERENCES `movie` (`MovieID`) ON DELETE CASCADE
...
INSERT INTO `Member` (`UserID`, `Name`, `Address`, `Phone`, `Email`, `CreditNo`, `CreditExp`)
VALUES
	(5,'Valen VB','196ORD','2262200245','valen@valenvb.ca','1234123412341234','2000-05-19');
...
VALUES
	...
	(11,'Saving Private Ryan',169,'R','Following the Normandy Landings, a group of U.S. soldiers go behind enemy lines to retrieve a paratrooper whose brothers have been killed in action.','Steven Spielberg',' DreamWorks','2018-05-17','2018-09-20',2),
	(13,'The Hunt for Red October',135,'PG','In November 1984, the Soviet Unions best submarine captain in their newest sub violates orders and heads for the USA. Is he trying to defect or to start a war?','John McTiernan',' Paramount','2018-04-12','2018-04-20',2),
	(24,'Ready Player One',140,'PG','When the creator of a virtual reality world called the OASIS dies, he releases a video in which he challenges all OASIS users to find his Easter Egg, which will give the finder his fortune.','Steven Spielberg',' Amblin Entertainment','2018-03-30','2018-06-30',3);
...
CREATE TABLE `reservation` (
  ...
  CONSTRAINT `reservation_ibfk_3` FOREIGN KEY (`STime`, `SDate`, `TheaterNo`, `ComplexNo`, `MovieID`) REFERENCES `Showing` (`STime`, `SDate`, `TheaterNo`, `ComplexNo`, `MovieID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `review` (
  ...
  CONSTRAINT `review_ibfk_3` FOREIGN KEY (`MovieID`) REFERENCES `movie` (`MovieID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

LOCK TABLES `review` WRITE;
/*!40000 ALTER TABLE `review` DISABLE KEYS */;

INSERT INTO `review` (`Words`, `UserID`, `Score`, `MovieID`)
VALUES
	('This movie was great ',5,5,6);
...
CREATE TABLE `Showing` (
  ...
  KEY `MovieID` (`MovieID`),
  CONSTRAINT `showing_ibfk_1` FOREIGN KEY (`ComplexNo`, `TheaterNo`) REFERENCES `Theater` (`ComplexNo`, `TheaterNo`) ON DELETE CASCADE,
  CONSTRAINT `showing_ibfk_3` FOREIGN KEY (`MovieID`) REFERENCES `movie` (`MovieID`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `theater` (
  ...
  CONSTRAINT `theater_ibfk_1` FOREIGN KEY (`ComplexNo`) REFERENCES `complex` (`ComplexNo`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
